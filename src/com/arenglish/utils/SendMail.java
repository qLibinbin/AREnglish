...
public class SendMail {
    ...
    public static String myEmailAccount = "1305833783@qq.com";
    public static String myEmailPassword = "gjwtkietxcnchici";
 
    // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
    // 网易126邮箱的 SMTP 服务器地址为: smtp.126.com
    // gmail 的 SMTP 地址 smtp.gmail.com
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "qlibinbin@gmail.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "AREnglish", "UTF-8"));
        ...
        String checkCode="654325";
        message.setContent("AREnglish注册的验证码:"+checkCode, "text/html;charset=UTF-8");
            // 6. 设置发件时间
